...
const oldAppendix = `   - worksheetContent: \${isPreschool ? 'Không bắt buộc với Mầm non, nếu có thì là bảng/phiếu trò chơi bằng hình ảnh. Nếu không có để chuỗi rỗng' : \`BẮT BUỘC TÁCH RÕ THÀNH 2 PHẦN RIÊNG BIỆT DẠNG BẢNG:
...
const newAppendix = `   - worksheetContent: \${config.schoolLevel === 'Mầm non' ? 'Không bắt buộc với Mầm non, nếu có thì là bảng/phiếu trò chơi bằng hình ảnh. Nếu không có để chuỗi rỗng' : \`BẮT BUỘC TÁCH RÕ THÀNH 2 PHẦN RIÊNG BIỆT DẠNG BẢNG:
     + PHẦN 1: PHIẾU HỌC TẬP DÀNH CHO HỌC SINH
       Tiêu đề: PHIẾU HỌC TẬP: [TÊN BÀI HỌC]
       Họ và tên: ................................................ Lớp: ................. Nhóm: .........
       Bảng bài tập của học sinh:
     ...
     + PHẦN 2: BẢNG GỢI Ý ĐÁP ÁN & HƯỚNG DẪN ĐÁNH GIÁ (DÀNH CHO GIÁO VIÊN)
       ...
       | 1 | [Nội dung câu hỏi 1] | [Gợi ý đáp án chi tiết, các bước giải, kết quả] | Đạt / 5.0 điểm |
       | 2 | [Nội dung câu hỏi 2] | [Gợi ý đáp án chi tiết, các bước giải, kết quả] | Đạt / 5.0 điểm |\`}
   - assignmentPrompt: \${config.schoolLevel === 'Mầm non' ? 'Không bắt buộc với mầm non. Nếu có thì nhắc nhở trẻ chia sẻ với bố mẹ.' : 'Hướng dẫn tự học & nhiệm vụ về nhà (BẮT BUỘC ghi rõ tên bài học tiếp theo của SGK Kết nối tri thức).'}`;
